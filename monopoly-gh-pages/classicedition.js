function Square(name, pricetext, color, price, groupNumber, baserent, rent1, rent2, rent3, rent4, rent5, question, answer) {
	this.name = name;
...
square[1] = new Square("Mediterranean Avenue", "$60", "#8B4513", 60, 3, 2, 10, 30, 90, 160, 250, "2+2", "4");
...
square[5] = new Square("Reading Railroad", "$200", "#FFFFFF", 200, 1, 0, 0, 0, 0, 0, 0, "5*9", "45");
